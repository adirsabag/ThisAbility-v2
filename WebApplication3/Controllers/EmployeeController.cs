    ...
    public class EmployeeController : Controller
    {
        ...
        public ActionResult CreateCV(Employee emp)
        {
            ...
            vm = new VM
            {
                ...
                {
                    ID =  (from x in dal.employees
                                                  where str == x.UserName
                                                  select x).ToList<Employee>()[0].ID
        }
        ...
        public ActionResult UpdateLang(VM p)
        {
            ...
            */
            ...
            string str = Session["user"].ToString();
            DataLayer dal = new DataLayer();
            string ID = (from x in dal.employees
                  where str == x.UserName
                  select x).ToList<Employee>()[0].ID;
        ...
        public ActionResult UpdateJobs(VM p)
        {
            ...
            vm.VolunteerNhobbies.id = vm.Pd.ID;
...
// vm.Employee = c.Employee;
        ...
        public ActionResult moveShowCV(String cvid)
        {
            ...
            return RedirectToAction("ShowCV", cv1);
        }
